...
public class StationInformationMenuItem extends JMenuItem {
    ...
    public StationInformationMenuItem() {
        ...
        addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (e.getSource() instanceof StationInformationMenuItem) {
                    ...
                    frame = new JFrame("Station Information");
...
*/
                    ...
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Latitude is not a valid number.");
                    }
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Longitude is not a valid number.");
                    }                    
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Transmission power is not a valid number.");
                    }   
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Antenna height is not a valid number.");                     
                    }  
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Terrain height is not a valid number.");
                    }                                 
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Heading is not a valid integer.");
                    }  
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Field of view angle is not a valid integer.");                        
                    }      
                    try {
                        ...
                        errors = true;
                        JOptionPane.showMessageDialog(frame, "Gain is not a valid number.");
                    }                          
